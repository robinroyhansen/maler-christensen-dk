...
export default function SEODashboard() {
  ...
  const fetchData = async () => {
    ...
    const staticPages = [
      ...
      { slug: "om-os", name: "Om os", url: "/om-os/", metaTitle: "Om os — Malerfirmaet Schou & Christensen | Slagelse", metaDescription: "Mød Jess og Stefan — ejerne af Schou & Christensen, lokalt malerfirma i Slagelse med 25+ års samlet erfaring. Medlem af Danske Malermestre. ★ 4.9 på Trustpilot" },
