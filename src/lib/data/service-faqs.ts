...
export const SERVICE_FAQS: Record<string, FAQ[]> = {
  "malerarbejde": [
    ...
    },
    {
      ...
      answer: "Ja, vi arbejder med kvalitetsmalinger fra anerkendte producenter som Flügger og Dyrup. Vi kan tilbyde vandbaserede og lavemitterende malinger, der er skånsomme for både miljø og indeklima."
    },
  ],
  "maling-af-carport": [
    {
